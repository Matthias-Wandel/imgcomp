...
function getHistogramX(a) {return a*HIST_WIDTH+a*HIST_SPACE_OFFSET+MARGIN_OFFSET; }
...
canv.addEventListener("mousemove", function(event) {
    ...
    for (a=0;a<60;a++){
        ...
        // ignore Y value because this eventlistener is only active on the canvas
        // all we need is X value
