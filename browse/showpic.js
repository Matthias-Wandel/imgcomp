...
console.log("update new="+nch+"  was=",currenthash);		
		if (nch != currenthash){
			console.log("set hash to: "+nch)
			location.hash = currenthash = nch
		}else console.log("hash stays same");
            
        document.title = imgname
		var Name = prefix+piclist[pic_index];
		document.getElementById("this").innerHTML = Name.substring(5,7)+":"+Name.substring(7,9)+":"+Name.substring(9,11)
    }
		
    UpdateActagram(flags)
}
